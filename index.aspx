...
<div id="tabs1" >
        <ul>
          <!-- CSS Tabs -->
          <li id="current"><a href="index.aspx"><span>Home</span></a></li>
    ...
    <div id="dvbannerbgcontainer">
      ...
      <div class="lftcontainer">
        <div class="dvbannerleft">
          ...
          <p><b>Election Candidate</b> Register yourself for as a election Candidate</p>
          <!-- banner left div ends here-->
        </div>
        <div class="dvbannerleft">
          <!-- banner left div starts here-->
          <img src="images/home_icon.jpg"  alt="" title=""/>
          <p><b>Voter Area</b> Get Register to able to vote on site.</p>
          <!-- banner left div ends here-->
        </div>
      </div>
      <div id="dvbanner">
        <!-- banner div starts here-->
        <img src="images/parlament2.jpg"  alt="" title=""/>
  ...
  <div id="dvfootercontainer">
    ...
    <div id="foottop">
      <p><span>Copyright © 2008 India</span> <a href="index.aspx" title="Home">Home</a><a href="result.aspx" title="result">Result</a><a href="adminlogin.aspx" title="admin">Admin</a></p>
