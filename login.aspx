...
<div id="tabs1" >
  ...
  <div id="dvbodycontainer">
    ...
    <div id="dvrightpanel">
      ...
      <h1 style="border-bottom:1;">Login Panel</h1>
      ...
      <tr height="35px">
      <td> <label for="type">Who you are:</label></td>
      ...
      <td> <asp:TextBox ID="TextBox1" runat="server" Width="230px"></asp:TextBox></td>
      <td> 
      ...
      <td> <asp:TextBox ID="TextBox2" runat="server" Width="230px" TextMode="Password"></asp:TextBox></td>
      <td> 
   ...
   <br />
      <div class="learn" style="padding-left:250px;">
